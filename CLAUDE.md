...
Build the architecture as you go. Do not create folders if they are not relevant for the current phase. Follow strict vertical slice architecture with tests living next to the code they test, here is an example:
